...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btMultiDel').click(function(){
			...
			$('form[name=frmList]').prop('action','<c:url value="/admin/product/deleteMulti2.do"/>');
...
<table width="700" class="box2" 
	...
	<!-- 반복 시작 -->
		<c:forEach var="vo" items="${list }">
			<tr>
				<td><input type="checkbox" name="chk" value="${vo.productNo }"></td>
...
<div class="divRight">
	<input type="button" value="선택한 상품 삭제" id="btMultiDel"><br><br>
	선택한 상품을
